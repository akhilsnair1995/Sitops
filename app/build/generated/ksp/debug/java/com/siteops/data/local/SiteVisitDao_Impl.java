...
public final class SiteVisitDao_Impl implements SiteVisitDao {
  ...
  @Override
  public Flow<SiteVisit> getVisitById(final long id) {
    final String _sql = "SELECT * FROM site_visits WHERE id = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, id);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"site_visits"}, new Callable<SiteVisit>() {
      @Override
      @Nullable
      public SiteVisit call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new SiteVisit(_tmpId,_tmpProjectId,_tmpTitle,_tmpDate,_tmpNotes,_tmpPhotoUris,_tmpPdfUri,_tmpMarkupsJson);
          } else {
            _result = null;
          }
          return _result;
